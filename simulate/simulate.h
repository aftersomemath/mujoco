...
// These function types are needed for the Python bindings
typedef mjModel* (*simulate_model_load_func)(const char*);
typedef mjData* (*simulate_data_from_model_func)(const mjModel*);
typedef void (*simulate_delete_model_func)(const mjModel*);
typedef void (*simulate_delete_data_func)(const mjData*);
LIBSIMULATEAPI void PhysicsThread(Simulate& sim, const char* filename,
                                 mjfGeneric preload_callback=nullptr, mjfGeneric load_callback=nullptr,
                                 simulate_model_load_func loader_xml=nullptr,
                                 simulate_model_load_func loader_binary=nullptr,
                                 simulate_data_from_model_func data_from_model=nullptr,
                                 simulate_delete_model_func delete_m=nullptr, simulate_delete_data_func delete_d=nullptr);
