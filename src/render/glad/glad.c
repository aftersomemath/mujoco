...
//
// Based on the OpenGL loader generated by glad 0.1.34 on Wed Jun 14 18:58:20 2023.
//
...
//
// Commandline:
//     --profile="compatibility" --api="gl=1.5" --generator="c" --spec="gl" --extensions="GL_ARB_clip_control,GL_ARB_color_buffer_float,GL_ARB_depth_buffer_float,GL_ARB_framebuffer_object,GL_ARB_seamless_cube_map,GL_ARB_vertex_buffer_object,GL_EXT_packed_depth_stencil,GL_KHR_debug"
// Online:
//     https://glad.dav1d.de/#profile=compatibility&language=c&specification=gl&loader=on&api=gl%3D1.5&extensions=GL_ARB_clip_control&extensions=GL_ARB_color_buffer_float&extensions=GL_ARB_depth_buffer_float&extensions=GL_ARB_framebuffer_object&extensions=GL_ARB_seamless_cube_map&extensions=GL_ARB_vertex_buffer_object&extensions=GL_EXT_packed_depth_stencil&extensions=GL_KHR_debug
...
int mjGLAD_GL_ARB_color_buffer_float = 0;
...
PFNGLCLAMPCOLORARBPROC mjGlad_glClampColorARB = NULL;
...
static void mjGlad_load_GL_ARB_color_buffer_float(GLADloadproc load) {
  if(!mjGLAD_GL_ARB_color_buffer_float) return;
  mjGlad_glClampColorARB = (PFNGLCLAMPCOLORARBPROC)load("glClampColorARB");
  printf("mjGlad_glClampColorARB %p\n", mjGlad_glClampColorARB);
}
...
static int mjGlad_find_extensionsGL(void) {
  ...
  mjGLAD_GL_ARB_color_buffer_float = mjGlad_has_ext("GL_ARB_color_buffer_float");
  printf("mjGLAD_GL_ARB_color_buffer_float %d\n", mjGLAD_GL_ARB_color_buffer_float);
...
int mjGladLoadGLUnsafe() {
  if(mjGlad_open_gl()) {
    ...
    mjGlad_load_GL_ARB_color_buffer_float(mjGlad_get_proc);
