...
GLAPI int mjGLAD_GL_ARB_color_buffer_float;
typedef void (APIENTRYP PFNGLCLAMPCOLORARBPROC)(GLenum target, GLenum clamp);
GLAPI PFNGLCLAMPCOLORARBPROC mjGlad_glClampColorARB;
#define glClampColorARB mjGlad_glClampColorARB
#endif
...
GLAPI int mjGLAD_GL_EXT_packed_depth_stencil;
#endif
#ifndef GL_KHR_debug
